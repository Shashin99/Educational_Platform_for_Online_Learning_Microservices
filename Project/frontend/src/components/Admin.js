        ...
        <Card style={{ maxWidth: 50 + '%', padding: "20px 5px", margin: "0 auto" }}>
          <CardContent>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <Button href="/allpayments" type="submit" variant="contained" color="primary" fullWidth>Payments</Button>
              </Grid>

              <Grid item xs={12}>
                <Button href="/report" type="submit" variant="contained" color="primary" fullWidth>Reports</Button>
              </Grid>
